...
const blueRayProducts = [
  {
    ...
    imageSrc:
      "/images/products/Blue-Ray_Biotech_EzDrop_1000_Micro-Volume_Spectrophotometer_s.png",
    brochurePath:
      "/pdf/Blue-Ray_Biotech_EzDrop_Series_Micro-Volume_Cuvette_Spectrophotometer_Brochure_Web (1).pdf",
    descriptionPoints: [
  ...
  },
  {
    ...
    imageSrc:
      "/images/products/Blue-Ray_Biotech_EzDrop_1000C_Micro-Volume_Cuvette_Spectrophotometer_s.png",
    brochurePath:
      "/pdf/Blue-Ray_Biotech_EzDrop_Series_Micro-Volume_Cuvette_Spectrophotometer_Brochure_Web.pdf",
    descriptionPoints: [
  ...
  },
  {
    ...
    imageSrc:
      "/images/products/Blue-Ray_Biotech_TurboCycler_2_PCR_thermal_cycler_s.png",
    brochurePath:
      "/pdf/Blue-Ray_Biotech_TurboCycler_2_PCR_Thermal_Cycler_Brochure_2020_web.pdf",
    descriptionPoints: [
  ...
  },
  {
    ...
    imageSrc:
      "/images/products/Blue-Ray_Biotech_TurboCycler_3_PCR_Thermal_Cycler_s.png",
    brochurePath:
      "/pdf/Blue-Ray_Biotech_TurboCycler_3_PCR_Thermal_Cycler_brochure_web.pdf",
    descriptionPoints: [
...
const ProductsPage = () => {
  ...
  const prevLabSlide = () => {
    setLabCurrentSlide(
      (prev) => (prev - 1 + labImages.length) % labImages.length,
    );
  };
  ...
  const handleDownload = async (path, fileName, productIndex) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          "Brochure not available. Please contact us for more information.",
        );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#F16A23]/10 border border-[#F16A23]/30 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm text-[#F16A23] font-semibold">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-10 leading-relaxed">
              From precision instruments to heavy-duty machinery, we source,
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a
                href="/contact"
                className="group bg-[#F16A23] text-white px-8 py-4 rounded-xl hover:bg-[#d85a19] transition-all duration-300 font-semibold shadow-lg hover:shadow-2xl hover:scale-105 flex items-center justify-center gap-2"
              >
                Get Started
              ...
              <a
                href="#products"
                className="bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-xl hover:bg-white/20 transition-all duration-300 font-semibold border border-white/20 hover:border-white/40"
              >
                View Products
              </a>
            </div>
          ...
          <div className="mx-auto gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
              ...
              <p className="text-lg leading-8 text-gray-600 mb-8">
                From basic analytical instruments to cutting-edge research
                equipment, we source and supply the complete spectrum of
                laboratory solutions with access to leading global brands.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                {[
                  {
                    icon: CheckCircle,
                    text: "Analytical & Testing Instruments",
                  },
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <a
                  href="/contact"
                  className="group w-full sm:w-auto rounded-xl bg-[#F16A23] px-8 py-4 text-sm font-semibold text-white shadow-lg hover:bg-[#d85a19] transition-all hover:scale-105 flex items-center justify-center gap-2"
                >
                  Get Custom Quote
                ...
                <a
                  href="/contact"
                  className="text-sm font-semibold text-gray-900 hover:text-[#F16A23] transition-colors flex items-center gap-2"
                >
                  Learn more
              ...
              >
                <div className="relative h-[500px] lg:h-[600px] overflow-hidden">
                  <div
                    ...
                    style={{
                      transform: `translateX(-${labCurrentSlide * 100}%)`,
                    }}
                  >
                ...
                {labImages.map((image, index) => (
                  ...
                  >
                    <img
                      ...
                      onError={(e) => {
                        e.target.src =
                          "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=100&h=100&fit=crop&q=80";
                      }}
                    />
                  </button>
                ))}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mb-16">
            ...
            <p className="text-xl leading-8 text-gray-600">
              Comprehensive medical equipment sourcing for hospitals, clinics,
              and healthcare facilities with certified, quality devices meeting
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              ...
              <p className="text-base leading-7 text-gray-600 mb-8">
                Healthcare equipment directly impacts patient outcomes. We
                maintain strict quality standards and work only with certified
                suppliers meeting international medical device regulations.
              </p>
              ...
              <div className="bg-gradient-to-br from-[#F16A23] to-[#d85a19] rounded-2xl p-8 text-white">
                ...
                <a
                  href="/contact"
                  className="mt-6 inline-block bg-white text-[#F16A23] px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="aspect-square overflow-hidden rounded-2xl shadow-xl">
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=400&h=400&fit=crop&q=80";
                  }}
                />
              </div>
              <div className="-mt-8 aspect-square overflow-hidden rounded-2xl shadow-xl">
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      "https://images.unsplash.com/photo-1581092795442-2f2e8b3e2e71?w=400&h=400&fit=crop&q=80";
                  }}
                />
              </div>
              <div className="aspect-square overflow-hidden rounded-2xl shadow-xl">
      ...
      <section
        id="products"
        className="bg-gradient-to-b from-gray-50 to-white py-24 border-t border-gray-100"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Benica East Africa Limited proudly represents Blue-Ray Biotech in
              Africa, offering cutting-edge laboratory instruments for your
              research needs.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {blueRayProducts.map((product, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-[#F16A23]/30 flex flex-col h-full"
              >
                {product.badge && (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-10 leading-relaxed">
              From supply and installation to expert training and ongoing
              maintenance, we provide complete end-to-end support ensuring your
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"
                className="group bg-[#F16A23] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#d85a19] transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 flex items-center justify-center gap-2"
              >
                Get Started Today
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <a
                href="/contact"
                className="bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white px-8 py-4 rounded-xl font-semibold hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-2"
              >
                Contact Sales Team
              </a>
            </div>
